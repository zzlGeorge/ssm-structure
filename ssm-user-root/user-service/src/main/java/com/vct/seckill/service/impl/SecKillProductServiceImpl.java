...
import com.vct.seckill.dao.mapper.SecKillProductUserMapper;
...
public class SecKillProductServiceImpl implements SecKillProductService {
    ...
    @Autowired
    private SecKillProductUserMapper secKillProductUserMapper;
    ...
    public List<SecKillProductDobj> querySecKillProductList() {
        return secKillProductUserMapper.querySecKillProductList();
    }
    ...
    public SecKillProductDobj queryProdById(String prodId) {
        ...
        if (secKillProductDobj == null) {
            ...
            secKillProductDobj = secKillProductUserMapper.queryProdById(prodId);
            // 回写缓存
    ...
    public void updateProdInfo(SecKillProductDO updateProdData) {
        ...
        int updateCount = 0;
        try {
            updateCount = secKillProductUserMapper.updateProdInfo(updateProdData);
        } catch (Exception e) {
            LOGGER.error("更新商品信息[异常],事务回滚,prodId={},e={}", prodId, e);
            String message =
